...
class ReflexEar:
    ...
    def button2_action(self):
        ...
        try:
            ...
            database_json.save_results(self.your_time, "Ucho")
        except:
            pass
    ...
    def beep_thread_func(self):
        while self.beep_flag:  # Dodaj pętlę
    ...
    def game(self):
        ...
        while self.running:
            ...
            if time.time() - self.start >= self.wait and not self.beep_thread_started:
                self.beep_flag = True  # Reset flagi dźwięku
                self.beep_thread = threading.Thread(target=self.beep_thread_func)
            ...
            self.draw_text("przycisku po usłyszeniu dźwięku.", self.BLACK, self.SCREEN_WIDTH / 2, 150)
